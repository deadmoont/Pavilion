...
class EventCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(builder: (_)=>SpecificEvent(image: event.image, title: "temporary", des: event.description, venue: event.venue,form: event.form,)));
      },
      child: Container(
